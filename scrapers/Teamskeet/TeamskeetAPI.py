...
studioMap = {
 ## SayUncle
    ...
    "FreeuseTwink": "Freeuse Twink",
    "JustSayUncle": "Just Say Uncle",
    ...
    "SayUncle Classics": "SayUncle Classics",
    "SayUncle Compilations": "SayUncle Compilations",
    "SayUncle Features": "SayUncle Features",
    "SayUncle Labs": "SayUncle Labs",
    "SayUncle x Blake Mason": "SayUncle x Blake Mason",
    "SayUncle x BoyFun": "SayUncle x BoyFun",
    "SayUncle x Callum and Cole": "SayUncle x Callum and Cole",
    "SayUncle x Club BangBoys": "SayUncle x Club BangBoys",
    "SayUncle x Cocksure Men": "SayUncle x Cocksure Men",
    "SayUncle x Cutlers Den": "SayUncle x Cutlers Den",
    "SayUncle x Frankfurt Sex Stories": "SayUncle x Frankfurt Sex Stories",
    "SayUncle x Gentlemen's Closet": "SayUncle x Gentlemen's Closet",
    "SayUncle x Hot Dads Hot Lads": "SayUncle x Hot Dads Hot Lads",
    "SayUncle x Jax Thirio": "SayUncle x Jax Thirio",
    "SayUncle x Lance Charger": "SayUncle x Lance Charger",
    "SayUncle x LatinoGuysPorn": "SayUncle x LatinoGuysPorn",
    "SayUncle x Manuel Skye": "SayUncle x Manuel Skye",
    "SayUncle x Masculine Jason": "SayUncle x Masculine Jason",
    "SayUncle x Maxx Stoner": "SayUncle x Maxx Stoner",
    "SayUncle x Nasty Daddy": "SayUncle x Nasty Daddy",
    "SayUncle x Of Love and Flesh": "SayUncle x Of Love and Flesh",
    "SayUncle x Pablo y Sebas": "SayUncle x Pablo y Sebas",
    "SayUncle x Pakinky": "SayUncle x Pakinky",
    "SayUncle x Phoenixxx": "SayUncle x Phoenixxx",
    "SayUncle x Randy Blue": "SayUncle x Randy Blue",
    "SayUncle x RawEuro": "SayUncle x RawEuro",
    "SayUncle x Santiago Wet": "SayUncle x Santiago Wet",
    "SayUncle x Seba Terry": "SayUncle x Seba Terry",
    "SayUncle x Spritzz": "SayUncle x Spritzz",
    "SayUncle x Staxus": "SayUncle x Staxus",
    "SayUncle x Super Twinks": "SayUncle x Super Twinks",
    "SayUncle x Trenton Ducati": "SayUncle x Trenton Ducati",
    "SayUncle x TwinkeyBoy": "SayUncle x TwinkeyBoy",
...
if "app.reptyle.com" in scene_url:
    ...
    # Reptyle URL is only needed internally.
    # Remove it before returning the scrape to Stash.
    public_scene.pop("url", None)
